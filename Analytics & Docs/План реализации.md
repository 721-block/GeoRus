...
#### Фаза 1: Подготовка и проектирование (3 недели)
- Анализ требований, создание детального ТЗ
- Проектирование архитектуры, выбор технологий

#### Фаза 2: Базовая инфраструктура (2 недели)
- Настройка серверной инфраструктуры, БД
- Разработка API
- **Базовая интеграция с картами

#### Фаза 3: Основной функционал (2 недель)
- Рисование и редактирование маршрутов
- Работа с узловыми точками
- Анализ маршрутов, расчеты
- Импорт/экспорт данных

#### Фаза 4: Расширенный функционал (3 недели)
- Притягивание к тропам, корректировка
- Архив маршрутов, поиск
- Оптимизация, тестирование

#### Фаза 5: Тестирование и развертывание (2 недели)
